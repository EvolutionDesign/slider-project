...
var images = [image1, image2, image3, image4]; //buttons

var btnNext = document.querySelector("#next");
var btnPrev = document.querySelector("#prev"); //counter

var count = 0; //set all the images to be in visible
...
function nextImage() {
  ...
  if (count === images.length - 1) {
    ...
    count = 0; //2. then start incrementing the count thru the array

    count++; //2.2 transtion timer

    body.style.transition = "all 1s ease-in-out"; //2.3 the increment in the access of the array

    var newImage = images[count]; //show the new image
...
function prevImage() {
  //when you click the btn
  //1. all the images should disappear with the function
  displayNone(); //we are going to insert a control flo w to deal with a bug
  ...
  if (count === 0) {
    ...
    count = images.length - 1; //2. then start incrementing the count thru the array
